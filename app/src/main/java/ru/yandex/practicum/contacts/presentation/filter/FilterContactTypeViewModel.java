...
public class FilterContactTypeViewModel extends BaseBottomSheetViewModel {
    ...
    private void updateFilterContactTypes() {
        ...
        ArrayList<FilterContactTypeUi> listFilter=new ArrayList<>();
        listFilter.add(createAllSelectedItem(strArr));
        for (String str : strArr) {
            listFilter.add(createFilterContactType(str));
        }
        ...
        filterContactTypesLiveDate.setValue(listFilter);
    }
